define('aurelia-deep-computed', ['exports', 'aurelia-framework', 'aurelia-binding'], function (exports, aureliaFramework, aureliaBinding) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function configure(config) {
        ...
        config.postTask(() => {
            const observerLocator = config.container.get(aureliaFramework.ObserverLocator);
            const parser = config.container.get(aureliaFramework.Parser);
